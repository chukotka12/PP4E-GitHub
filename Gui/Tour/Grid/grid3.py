"""
добавление метки в верхней части окна и возможность изменения размеров
"""
from tkinter import *
...
def gridbox(root):
    Label(root, text='Grid').grid(columnspan=2) # объединение колонок аналогично rowspan
    row = 1
    for color in colors:
        ...
        row += 1
    # вес заставляет изменять размер в разных пропорциях
